...
class ChildStore:
    ...
    def get_download_status(self, video_id):
        return self._store.get_download_status(video_id, profile_id=self.profile_id)

    def set_download_status(self, video_id, status):
        return self._store.set_download_status(video_id, status, profile_id=self.profile_id)
