...
- **Localized UI and bot** — English, French and Norwegian, with an EN/FR toggle in the header that switches the interface *and* video titles for that browser only, plus locale-aware or forced 12h/24h time display
